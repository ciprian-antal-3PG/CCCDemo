...
@interface CCCPhotoCaptureAdjusterInfo : UIView
...
@property (strong, nonatomic) CCCPhotoCaptureAdjuster  * _Nonnull adjusterInfo;

-(IBAction)dismissAdjusterInfo;
+(void)showInViewController:(UIViewController*)viewController withAdjusterInfo:(CCCPhotoCaptureAdjuster *) adjusterInfo;
@end
